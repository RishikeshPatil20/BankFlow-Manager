...
<body>
	<form action="Home" method="post">
		...
		<div id="logo">
			...
			<div id="name">BANK OF BHARAT </div>
			<div id="content">
			...
			<div class="button" style="width: 150px; height: 40px; font-size: 15px; background-color: blue; 	
						color: white; text-align: center; line-height: 40px; cursor: pointer;">
						Create Account</div>
				</a>
			</div>
